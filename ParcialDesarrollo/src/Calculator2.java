    ...
    private Consumer<ItemEvent> themeSwitchEventConsumer = event -> {
        ...
        switch (selectedTheme) {
            ...
            case "Colored":
                ...
                break;
            case "DarkTheme":
                final Color primaryDarkColor = new Color(243, 4, 144);
                final Color secondaryDarkColor = new Color(203, 78, 127, 255);

                window.getContentPane().setBackground(new Color(13, 14, 17));
