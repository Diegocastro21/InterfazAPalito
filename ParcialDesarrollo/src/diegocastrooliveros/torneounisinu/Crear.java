...
public class Crear extends JFrame {
    ...
    public Crear() {
        ...
        JLabel lblNewUserRegister = new JLabel("Registro Nuevo Usuario");
        ...
        JLabel lblMobileNumber = new JLabel("Numero De Telefono");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(len==10)
                {
                    JOptionPane.showMessageDialog(btnNewButton,"Bienvenido, "+msg+" Su cuenta se creo con exito!");
                }
                else
                {
                    JOptionPane.showMessageDialog(btnNewButton, "Ingresa un numero telefonico valido: min 10 numeros");
                }
        ...
        btnNewButton_1 = new JButton("¿Ya tienes cuenta? Iniciar sesión");
